...
class TurfCategory {
  TurfCategory(
      {required this.turfCricket,
      required this.turfBadminton,
      required this.turfYoga,
      required this.urfFootball});
  ...
  factory TurfCategory.fromJson(Map<String, dynamic> json) => TurfCategory(
        turfCricket: json["turf_cricket"],
        urfFootball: json["turf_football"],
        turfBadminton: json["turf_badminton"],
        turfYoga: json["turf_yoga"],
      );
